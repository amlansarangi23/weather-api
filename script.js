let apiUrl= "https://api.open-meteo.com/v1/forecast?latitude=52.52&longitude=13.41&current_weather=true&hourly=temperature_2m,relativehumidity_2m,windspeed_10m&daily";
...
async function checkWeather(mylat,mylon){
    apiUrl = apiUrl.replace("latitude=52.52","latitude="+ mylat).replace("longitude=13.41","longitude="+ mylon)
